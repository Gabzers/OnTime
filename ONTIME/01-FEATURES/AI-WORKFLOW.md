...
Hub: [[OnTime]] · Tasks: [[AI-TASK-PLAN]] · Setup: [[LOCAL-AI-SETUP]].
...
1. **RED — write the ideal test first.**
   - Backend: add/extend a flow test in `OnTime.Tests/Flows` (see [[TESTING]]).
...
4. **SYNC DOCS — update the vault** (table in [[HOW-TO-USE]]): tick [[AI-TASK-PLAN]] / [[KNOWN-ISSUES]],
   update [[DOMAIN]]/[[SCHEMA-AUTH]]/[[API-REFERENCE]] if anything changed. No session log — Git
   history covers "what happened when"; only durable facts/rules belong in the vault.
...
> (and note why in the relevant vault note).
...
## Related
[[AI-TASK-PLAN]] · [[TESTING]] · [[CONVENTIONS]] · [[HOW-TO-USE]] · [[OnTime]]
