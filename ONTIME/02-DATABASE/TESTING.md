...
Hub: [[OnTime]] · Source: `OnTime.Tests` + `ONTIME_TESTING_SPEC.md`.
...
## Run
```bash
cd OnTime_Backend && dotnet test    # Docker required (Testcontainers)
```

## Related
[[PAYMENTS]] · [[NOTIFICATIONS]] · [[ARCHITECTURE]] · [[OnTime]]
